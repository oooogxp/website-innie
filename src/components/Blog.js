        ...
        return(
            <div>
                <div className="flex-align">
                    <article className="flex-align border-blog">
                        <h3>2021.01.13</h3>
                        <h1>첫 버그를 만났다</h1>
                        <p className="line-height content-blog">지금은 새벽 한 시. 이 와중에 발견한 첫 버그..! 내가 첫 버그라니!<br/>
                    ...
                    <article className="flex-align border-blog">
                        <h3>2021.01.12</h3>
                        <h1>Snowy Day!</h1>
                        <p className="line-height content-blog">지난주에 이어 오늘도 폭설이 내렸다. 순식간에 5cm는 쌓인 것 같다. 온 세상이 하얗다!<br/>
                    ...
                    <article className="flex-align border-blog">
                        <h3>2021.01.11</h3>
                        <h1>너무 졸리다</h1>
                        <p className="line-height content-blog">요즘(?) 아침에 눈 뜨는게 너무 힘들다.<br/>
                    ...
                    <article className="flex-align border-blog">
                        <h3>2021.01.10</h3>
                        <h1>애플 전기차</h1>
                        <p className="line-height content-blog">애플에서 전기 자동차를 만들 예정이라는 기사를 보고 너무 설렜다.<br/>
